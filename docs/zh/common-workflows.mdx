...
<CardGroup cols={2}>
  <Card title="企业附件入口" icon="inbox" iconType="solid" href="#在云端处理前校验文档上传">
  ...
  <Card title="多模态理解与评审" icon="eye" iconType="solid" href="#组合校验内容和预览">
    把 DeckOps 内容结果和 DeckRender 视觉产物作为相互独立、可追踪的输入，用于搜索、AI、预览或人工评审。
  </Card>
  <Card title="生成文档的交付检查" icon="clipboard-check" iconType="solid" href="#从应用数据生成-deck">
