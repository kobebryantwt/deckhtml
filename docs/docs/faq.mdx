...
title: FAQ
sidebarTitle: FAQ
description: "Find answers to common questions about DeckHTML usage, outputs, integrations, and deployment models."
---
...
DeckHTML focuses on `pptx` and `png`.

## When do I need authentication?

Authentication is required for cloud execution and the cloud-only `--embed-fonts` flag.
