...
<CardGroup cols={2}>
  <Card title="Enterprise attachment intake" icon="inbox" iconType="solid" href="#gate-document-uploads-before-cloud-processing">
  ...
  <Card title="Multimodal understanding and review" icon="eye" iconType="solid" href="#combine-validation-content-and-previews">
  ...
  <Card title="Generated-document delivery check" icon="clipboard-check" iconType="solid" href="#generate-a-deck-from-application-data">
