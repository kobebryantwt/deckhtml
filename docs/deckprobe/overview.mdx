...
- Applying bounded read, decompression, and archive-entry limits plus a cooperative time budget.
...
<CardGroup cols={2}>
  ...
  <Card title="Formats and targets" href="/deckprobe/formats-and-targets">
    Review supported document families, target discovery, and probe levels.
  </Card>
</CardGroup>
