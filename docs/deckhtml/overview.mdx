...
description: "Turn browser-rendered HTML or SVG into PPTX or PNG, with explicit editability and fallback diagnostics."
---

DeckHTML loads HTML or SVG in Chromium, measures the rendered layout, and produces PPTX or PNG. For PPTX, it rebuilds supported text, images, tables, shapes, SVG geometry, and equations as editable or vector objects. When no reliable PowerPoint mapping exists, it can preserve appearance with a raster fallback and record that decision in the conversion report.
