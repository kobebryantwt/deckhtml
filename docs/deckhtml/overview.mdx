...
- The [DeckHTML repository](https://github.com/deckflow/deckhtml) contains the local conversion engine, CLI, and Node.js API. Use it to inspect local behavior, follow releases, or report an issue.
- Cloud mode is provided through DeckFlow. See [Authentication](/deckhtml/authentication) to try guest mode or configure authenticated cloud access.
